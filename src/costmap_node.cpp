...
public:
  CostmapNode() : Node("costmap_node")
  {
    ...
    costmap_options.parameter_overrides({
      ...
      {"width",              rclcpp::ParameterValue(20)},
      {"height",             rclcpp::ParameterValue(20)},
      ...
      {"origin_x",   rclcpp::ParameterValue(-10.0)},
      {"origin_y",   rclcpp::ParameterValue(-10.0)},
      ...
      {"obstacle_layer.pointcloud_sensor.topic",               rclcpp::ParameterValue(std::string("/bev_obstacles"))},
      ...
      {"obstacle_layer.pointcloud_sensor.min_obstacle_height", rclcpp::ParameterValue(0.0)},
      {"obstacle_layer.pointcloud_sensor.max_obstacle_height", rclcpp::ParameterValue(2.0)},
      {"obstacle_layer.pointcloud_sensor.obstacle_max_range",  rclcpp::ParameterValue(6.0)},
      {"obstacle_layer.pointcloud_sensor.raytrace_max_range",  rclcpp::ParameterValue(8.0)},
